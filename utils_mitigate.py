# This code is taken from https://github.com/eric-ai-lab/Mitigate-Gender-Bias-in-Image-Search/blob/main/utils.py
# to demonstrate the comparisons with their method. 
